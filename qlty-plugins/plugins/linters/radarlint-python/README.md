...
```bash
qlty plugins enable radarlint-python
```
...
radarlint-python will be automatically enabled by `qlty init` if a `radarlint.properties` configuration file is present.

## Languages and file types

radarlint-python analyzes: Python (`.py`).

## Configuration files

- `radarlint.properties`

To keep your project tidy, you can move configuration files into `.qlty/configs` and Qlty will find and use them when running radarlint-python.
...
- [radarlint-python plugin definition](https://github.com/qltysh/qlty-plugins/tree/main/plugins/linters/radarlint-python)
