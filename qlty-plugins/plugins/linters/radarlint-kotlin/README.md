...
radarlint-kotlin will be automatically enabled by `qlty init` if a `radarlint.properties` configuration file is present.

## Languages and file types

radarlint-kotlin analyzes: Kotlin (`.kt`, `.kts`).

## Configuration files

- `radarlint.properties`

To keep your project tidy, you can move configuration files into `.qlty/configs` and Qlty will find and use them when running radarlint-kotlin.
...
- [radarlint-kotlin plugin definition](https://github.com/qltysh/qlty-plugins/tree/main/plugins/linters/radarlint-kotlin)
