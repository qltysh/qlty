...
impl serde::Serialize for ExitResult {
        ...
        S: serde::Serializer,
    {
        let variant = match self {
            ...
            Self::MissingOutputError => "EXIT_RESULT_MISSING_OUTPUT_ERROR",
        };
        serializer.serialize_str(variant)
    }
}
impl<'de> serde::Deserialize<'de> for ExitResult {
        ...
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &[
            ...
            "EXIT_RESULT_MISSING_OUTPUT_ERROR",
        ];
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                match value {
                    ...
                    "EXIT_RESULT_MISSING_OUTPUT_ERROR" => Ok(ExitResult::MissingOutputError),
                    _ => Err(serde::de::Error::unknown_variant(value, FIELDS)),
                }
            }
        }
