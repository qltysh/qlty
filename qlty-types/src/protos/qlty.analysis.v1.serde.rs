...
impl serde::Serialize for ToolInstallSummary {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if self.install_script.is_some() {
            len += 1;
        }
        if self.install_stdout.is_some() {
            len += 1;
        }
        if self.install_stderr.is_some() {
            len += 1;
        }
        if self.install_exit_code.is_some() {
            len += 1;
        }
        if !self.install_env.is_empty() {
            len += 1;
        }
        ...
        let mut struct_ser = serializer.serialize_struct("qlty.analysis.v1.ToolInstallSummary", len)?;
        if !self.tool_name.is_empty() {
        ...
        if let Some(v) = self.install_script.as_ref() {
            struct_ser.serialize_field("installScript", v)?;
        }
        if let Some(v) = self.install_stdout.as_ref() {
            struct_ser.serialize_field("installStdout", v)?;
        }
        if let Some(v) = self.install_stderr.as_ref() {
            struct_ser.serialize_field("installStderr", v)?;
        }
        if let Some(v) = self.install_exit_code.as_ref() {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("installExitCode", ToString::to_string(&v).as_str())?;
        }
        if !self.install_env.is_empty() {
            struct_ser.serialize_field("installEnv", &self.install_env)?;
        }
...
impl<'de> serde::Deserialize<'de> for ToolInstallSummary {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "installScript" | "install_script" => Ok(GeneratedField::InstallScript),
                            "installStdout" | "install_stdout" => Ok(GeneratedField::InstallStdout),
                            "installStderr" | "install_stderr" => Ok(GeneratedField::InstallStderr),
                            "installExitCode" | "install_exit_code" => Ok(GeneratedField::InstallExitCode),
                            "installEnv" | "install_env" => Ok(GeneratedField::InstallEnv),
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ToolInstallSummary;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct qlty.analysis.v1.ToolInstallSummary")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ToolInstallSummary, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut install_script__ = None;
                let mut install_stdout__ = None;
                let mut install_stderr__ = None;
                let mut install_exit_code__ = None;
                let mut install_env__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::InstallScript => {
                            if install_script__.is_some() {
                                return Err(serde::de::Error::duplicate_field("installScript"));
                            }
                            install_script__ = map_.next_value()?;
                        }
                        GeneratedField::InstallStdout => {
                            if install_stdout__.is_some() {
                                return Err(serde::de::Error::duplicate_field("installStdout"));
                            }
                            install_stdout__ = map_.next_value()?;
                        }
                        GeneratedField::InstallStderr => {
                            if install_stderr__.is_some() {
                                return Err(serde::de::Error::duplicate_field("installStderr"));
                            }
                            install_stderr__ = map_.next_value()?;
                        }
                        GeneratedField::InstallExitCode => {
                            if install_exit_code__.is_some() {
                                return Err(serde::de::Error::duplicate_field("installExitCode"));
                            }
                            install_exit_code__ = 
                                map_.next_value::<::std::option::Option<::pbjson::private::NumberDeserialize<_>>>()?.map(|x| x.0)
                            ;
                        }
                        GeneratedField::InstallEnv => {
                            if install_env__.is_some() {
                                return Err(serde::de::Error::duplicate_field("installEnv"));
                            }
                            install_env__ = Some(
                                map_.next_value::<std::collections::HashMap<_, _>>()?
                            );
                ...
                Ok(ToolInstallSummary {
                    ...
                    install_script: install_script__,
                    install_stdout: install_stdout__,
                    install_stderr: install_stderr__,
                    install_exit_code: install_exit_code__,
                    install_env: install_env__.unwrap_or_default(),
        ...
        deserializer.deserialize_struct("qlty.analysis.v1.ToolInstallSummary", FIELDS, GeneratedVisitor)
    }
}
